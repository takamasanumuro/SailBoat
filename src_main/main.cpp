...
//#include "Servo.h"
    ...
    #define SYSTEM_NAME "SailBoat Autopilot Main"
#endif
...
void setup() {
    ...
    #ifdef ENVIRONMENT_MAIN
        Serial.println("===================================");
        Serial.print("Starting: "); Serial.println(SYSTEM_NAME);
        Serial.print("Version: "); Serial.println(MAIN_VERSION);
        Serial.println("Environment: MAIN (Production)");
        Serial.println("===================================");
    #endif
